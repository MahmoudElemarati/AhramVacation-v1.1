...
import com.ahramattend.www._0_0_0_0_1_MainMenu.dbMenu;
...
public class SystemMainFilter implements Filter {
    ...
    private synchronized void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
    ...
    public synchronized void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            PerEmploymentMasters employee_session = (PerEmploymentMasters) req.getSession().getAttribute("employee_session");
            ...
            e.printStackTrace();
            res.sendRedirect("_0_0_0_0_0_1_login_AccessServlet");
        }
        HibernateSessionCon.session.clear();
        HibernateSessionCon.closeConn();
    }

    public void FilterFunction(String AccessServlet, PerEmploymentMasters employee_session) throws Exception {
