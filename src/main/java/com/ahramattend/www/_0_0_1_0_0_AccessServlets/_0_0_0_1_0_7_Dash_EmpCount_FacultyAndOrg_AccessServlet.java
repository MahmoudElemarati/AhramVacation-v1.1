 ...
 * @author MSaeed
 */
public class _0_0_0_1_0_7_Dash_EmpCount_FacultyAndOrg_AccessServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("QualClassCode", QualClassCode);
        request.getSession().setAttribute("FacultyCode", FacultyCode);
        ...
        response.sendRedirect("_0_0_0_1_0_7_Dash_EmpCount_FacultyAndOrg.jsp");
    }
