 ...
 * @author Mohamed
 */
public class _0_0_0_5_0_1_PayEmployeeReq_print_AccessServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("ReqSp", ReqSp);
        ...
        response.sendRedirect("_0_0_0_5_0_1_PayEmployeeReq_print.jsp");
