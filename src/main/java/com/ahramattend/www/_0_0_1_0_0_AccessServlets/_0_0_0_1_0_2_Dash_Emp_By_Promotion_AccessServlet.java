 ...
 * @author amac
 */
public class _0_0_0_1_0_2_Dash_Emp_By_Promotion_AccessServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("jobLaw", jobLaw);
        request.getSession().setAttribute("PromotionType", PromotionType);
        ...
        response.sendRedirect("_0_0_0_1_0_2_Dash_Emp_By_Promotion.jsp");
