...
public class PerAnnualEval  implements java.io.Serializable {
    ...
    public PerAnnualEval(PerAnnualEvalId id, PerOrganizationStructure perOrganizationStructure, PerOrgunitCode perOrgunitCode, BudProjectSub budProjectSub, PerAnnualEvalYear perAnnualEvalYear, Date evalDate, String empDirectBoss, String empBigBoss, String commityNo, Set<PerAnnualEvalEmp> perAnnualEvalEmps) {
       this.id = id;
