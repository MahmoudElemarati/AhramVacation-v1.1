...
public class PerAnnualEvalEmp  implements java.io.Serializable {
    ...
    public PerAnnualEvalEmp(PerAnnualEvalEmpId id, PerGroupDegree perGroupDegree, PerGroupDegreeNew perGroupDegreeNew, PerJobCode perJobCode, PerEvalPercentage perEvalPercentageByGradeCodeBigboss, PerEvalPercentage perEvalPercentageByGradeCode, PerEvalPercentage perEvalPercentageByGradeCodeFinal, PerEvalPercentage perEvalPercentageByGradeCodeComm, PerAnnualEval perAnnualEval, PerEmploymentMasters perEmploymentMasters, Set<PerAnnualEvalEmpDetail> perAnnualEvalEmpDetails) {
       this.id = id;
