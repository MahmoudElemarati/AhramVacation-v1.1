...
public class PerQualSpecialist  implements java.io.Serializable {
    ...
    public PerQualSpecialist(PerQualSpecialistId id, PerQualCode perQualCode, PerSpecialistCode perSpecialistCode) {
        this.id = id;
        this.perQualCode = perQualCode;
        this.perSpecialistCode = perSpecialistCode;
    }
    public PerQualSpecialist(PerQualSpecialistId id, PerQualCode perQualCode, PerSpecialistCode perSpecialistCode, String notes, String recordCreateUser, Date recordCreateDate, String recordUpdateUser, Date recordUpdateDate, Set<PerJobDetail> perJobDetails, Set<PerEmpQualification> perEmpQualifications) {
       this.id = id;
       this.perQualCode = perQualCode;
       this.perSpecialistCode = perSpecialistCode;
       this.notes = notes;
