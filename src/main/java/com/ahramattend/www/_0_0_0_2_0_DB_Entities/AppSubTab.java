...
public class AppSubTab  implements java.io.Serializable {
    ...
    public AppSubTab(AppSubTabId id, AppSubTabAuthType appSubTabAuthType, AppTabs appTabs, String subTabName, String subTabAccessservlet, String availableToUserControl, Integer subTabIndex, Set<AppSubTabSpecAuth> appSubTabSpecAuths, Set<AppSubElem> appSubElems) {
       this.id = id;
