...
public class PayDeserveEmpFileDtl  implements java.io.Serializable {
    ...
    public PayDeserveEmpFileDtl(PayDeserveEmpFileDtlId id, PayDeserveEmpFile payDeserveEmpFile, PayEmployeeMaster payEmployeeMasterByEmployeeId, String employeeNo) {
        this.id = id;
        this.payDeserveEmpFile = payDeserveEmpFile;
        this.payEmployeeMasterByEmployeeId = payEmployeeMasterByEmployeeId;
        this.employeeNo = employeeNo;
    }
    public PayDeserveEmpFileDtl(PayDeserveEmpFileDtlId id, PayDeserveEmpFile payDeserveEmpFile, PayEmployeeMaster payEmployeeMasterByEmployeeId, PayEmployeeMaster payEmployeeMasterByEmployeeIdUser, String employeeNo, BigDecimal val, Date currDate, String currTime, String rmrk) {
       this.id = id;
       this.payDeserveEmpFile = payDeserveEmpFile;
       this.payEmployeeMasterByEmployeeId = payEmployeeMasterByEmployeeId;
