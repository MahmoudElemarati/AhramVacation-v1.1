...
public class PerAnnualEvalEmpDetail  implements java.io.Serializable {
    ...
    public PerAnnualEvalEmpDetail(PerAnnualEvalEmpDetailId id, PerEvalAttributeSpecialDtl perEvalAttributeSpecialDtl, PerAnnualEvalEmp perAnnualEvalEmp, PerEvalAttributeDetail perEvalAttributeDetail, PerEvalPercentage perEvalPercentageByGradeCodeComm, PerEvalPercentage perEvalPercentageByGradeCode, PerEvalPercentage perEvalPercentageByGradeCodeBigboss, String attributeNo, int directBossDegree, String directBossOpinion, Integer bigBossDegree, String bigBossOpinion, Integer commityDegree, String commityOpinion) {
       this.id = id;
