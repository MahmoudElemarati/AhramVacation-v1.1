...
public class PayDeserveEmpFile  implements java.io.Serializable {
    ...
    public PayDeserveEmpFile(PayDeserveEmpFileId id, PayExecutionOpen payExecutionOpen, PayLocationBandFile payLocationBandFile) {
        this.id = id;
        this.payExecutionOpen = payExecutionOpen;
        this.payLocationBandFile = payLocationBandFile;
    }
    public PayDeserveEmpFile(PayDeserveEmpFileId id, NvUsers nvUsers, PayEmployeeMaster payEmployeeMasterByEmployeeIdSent, PayEmployeeMaster payEmployeeMasterByEmployeeId, PayExecutionOpen payExecutionOpen, PayLocationBandFile payLocationBandFile, Byte chkStatus, Date currDate, String currTime, Date sendDate, String sendTime, Date pickDate, String pickTime, String rmrk, Set<PayDeserveEmpFileDtlRuf> payDeserveEmpFileDtlRufs, Set<PayDeserveEmpFileDtl> payDeserveEmpFileDtls) {
       this.id = id;
