...
public class PerEmpQualification  implements java.io.Serializable {
    ...
    public PerEmpQualification(PerEmpQualificationId id, PerEmploymentMasters perEmploymentMasters, PerQualCode perQualCode, PerQualFaculty perQualFaculty, PerQualSpecialist perQualSpecialist, Date qualYear) {
        this.id = id;
    ...
    public PerEmpQualification(PerEmpQualificationId id, PerSpecialistCode perSpecialistCode, PerUniversityCode perUniversityCode, PerEmploymentMasters perEmploymentMasters, PerFacultyCode perFacultyCode, PerFacultyUniversity perFacultyUniversity, PerQualCode perQualCode, PerQualFaculty perQualFaculty, PerQualSpecialist perQualSpecialist, Date qualYear, BigDecimal empPercent, Byte docPages, String remarks) {
       this.id = id;
