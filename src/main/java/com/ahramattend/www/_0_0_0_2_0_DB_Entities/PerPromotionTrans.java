...
public class PerPromotionTrans  implements java.io.Serializable {
    ...
    public PerPromotionTrans(PerPromotionTransId id, PerFiscalDegreeCode perFiscalDegreeCodeByFiscalDegreeCodeNew, PerPromotionRule perPromotionRule, BudLocation budLocation, PerCommityMaster perCommityMaster, Date promotionDate, String fiscalDegreeCode, boolean aprPromotion, boolean elawaCalc, boolean degreeEndSalaryFlg) {
        this.id = id;
    ...
    public PerPromotionTrans(PerPromotionTransId id, PerFiscalDegreeCode perFiscalDegreeCodeByFiscalDegreeCodeEndSalary, PerFiscalDegreeCode perFiscalDegreeCodeByFiscalDegreeCodeNew, PerGroupTypeCode perGroupTypeCode, PerJobCode perJobCode, PerPromotionRule perPromotionRule, BudLocation budLocation, PerCommityMaster perCommityMaster, Date promotionDate, String fiscalDegreeCode, Byte promotionRate, boolean aprPromotion, String decisionNo, Date decisionDate, Date postDate, Byte promotionRateMain, BigDecimal elawaRatio, Date salaryMonth, boolean elawaCalc, boolean degreeEndSalaryFlg, Short VBandCode, Byte VMethodType, Byte addElawaType, Set<PerEmpPromotion> perEmpPromotions) {
       this.id = id;
