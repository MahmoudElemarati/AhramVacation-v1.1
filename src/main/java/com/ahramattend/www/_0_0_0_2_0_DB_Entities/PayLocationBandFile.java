...
public class PayLocationBandFile  implements java.io.Serializable {
    ...
    public PayLocationBandFile(PayLocationBandFileId id, PayBandCode payBandCode, PerLocationCodes perLocationCodes) {
        this.id = id;
        this.payBandCode = payBandCode;
        this.perLocationCodes = perLocationCodes;
    }
    public PayLocationBandFile(PayLocationBandFileId id, PayBandCode payBandCode, PayMethodType payMethodType, PerLocationCodes perLocationCodes, String chkBand, String rmrk, Set<PayDeserveEmpFileStopDtl> payDeserveEmpFileStopDtls, Set<PayDeserveEmpFile> payDeserveEmpFiles) {
       this.id = id;
       this.payBandCode = payBandCode;
