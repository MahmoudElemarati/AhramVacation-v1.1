...
public class AppSubTabSpecAuthId  implements java.io.Serializable {
    ...
    public AppSubTabSpecAuthId(int subTabId, String employeeId, short applicationId, int tabId, byte primaryAuthPass) {
    ...
    public AppSubTabSpecAuthId(int subTabId, String employeeId, String employeeIdAction, Date actionDate, String actionDateDetails, short applicationId, int tabId, byte primaryAuthPass) {
       this.subTabId = subTabId;
       this.employeeId = employeeId;
 ...
 && (this.getPrimaryAuthPass()==castOther.getPrimaryAuthPass());
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + this.getPrimaryAuthPass();
         return result;
   }   
