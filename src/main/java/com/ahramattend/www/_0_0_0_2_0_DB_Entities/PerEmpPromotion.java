...
public class PerEmpPromotion  implements java.io.Serializable {
    ...
    public PerEmpPromotion(PerEmpPromotionId id, PerFiscalDegreeCode perFiscalDegreeCodeByFiscalDegreeCode, PerJobCode perJobCodeByJobCode, PerPromotionTrans perPromotionTrans, PerEmploymentMasters perEmploymentMasters) {
        this.id = id;
    ...
    public PerEmpPromotion(PerEmpPromotionId id, PerFiscalDegreeCode perFiscalDegreeCodeByFiscalDegreeCode, PerFiscalDegreeCode perFiscalDegreeCodeByFiscalDegreeCodeNew, PerGroupDegree perGroupDegree, PerGroupTypeCode perGroupTypeCodeByGroupTypeCodeNew, PerGroupTypeCode perGroupTypeCodeByGroupTypeCode, PerJobCode perJobCodeByJobCodeNew, PerJobCode perJobCodeByJobCode, PerPromotionTrans perPromotionTrans, PerEmploymentMasters perEmploymentMasters, Date degreeDate, Date degreePriorityDate, Date jobDate, Boolean empJobFlag, BigDecimal basicSal, BigDecimal sal, Date degreeDateNew, Date jobDateNew, Boolean empJobFlagNew, BigDecimal elawaVal, BigDecimal basicSalAfter, BigDecimal salAfter, BigDecimal calcVal, Date degreePriorityDateNew) {
       this.id = id;
       this.perFiscalDegreeCodeByFiscalDegreeCode = perFiscalDegreeCodeByFiscalDegreeCode;
