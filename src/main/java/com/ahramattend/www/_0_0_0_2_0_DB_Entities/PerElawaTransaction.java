...
public class PerElawaTransaction  implements java.io.Serializable {
    ...
    public PerElawaTransaction(PerElawaTransactionId id, PerEmploymentMasters perEmploymentMasters, PerJobCode perJobCode, PerLocationCodes perLocationCodes, BigDecimal basicSalaryValueB, BigDecimal salaryValueB, boolean elawaCalc, BigDecimal elawaValue, BigDecimal basicSalaryValueA, BigDecimal salaryValueA) {
        this.id = id;
    ...
    public PerElawaTransaction(PerElawaTransactionId id, PerFiscalDegreeCodeNew perFiscalDegreeCodeNew, PerEmploymentMasters perEmploymentMasters, PerFiscalDegreeCode perFiscalDegreeCode, PerGroupTypeCode perGroupTypeCode, PerJobCode perJobCode, PerLocationCodes perLocationCodes, Date degreeDate, Date jobDate, BigDecimal basicSalaryValueB, BigDecimal salaryValueB, boolean elawaCalc, BigDecimal elawaValue, BigDecimal basicSalaryValueA, BigDecimal salaryValueA, String constantElawaFg, Boolean elawaDecisionFg) {
       this.id = id;
