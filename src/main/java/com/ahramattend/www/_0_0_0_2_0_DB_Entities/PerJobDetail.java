...
public class PerJobDetail  implements java.io.Serializable {
    ...
    public PerJobDetail(PerJobDetailId id, PerJobCode perJobCode, PerQualCode perQualCode, PerQualSpecialist perQualSpecialist, PerSpecialistCode perSpecialistCode) {
        this.id = id;
    ...
    public PerJobDetail(PerJobDetailId id, PerJobCode perJobCode, PerQualCode perQualCode, PerQualSpecialist perQualSpecialist, PerSpecialistCode perSpecialistCode, String notes, String recordCreateUser, Date recordCreateDate, String recordUpdateUser, Date recordUpdateDate) {
       this.id = id;
       this.perJobCode = perJobCode;
       this.perQualCode = perQualCode;
       this.perQualSpecialist = perQualSpecialist;
