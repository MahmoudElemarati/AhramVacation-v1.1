...
public class PerAnnualEvalModel  implements java.io.Serializable {
    ...
    public PerAnnualEvalModel(PerAnnualEvalModelId id, PerOrganizationStructure perOrganizationStructure, PerOrgunitCode perOrgunitCode, BudProjectSub budProjectSub, PerAnnualEvalType perAnnualEvalType, PerAnnualEvalYear perAnnualEvalYear, String empDirectBoss, String commityNo, Date evalDate, String empBigBoss, Set<PerAnnualEvalModelEmp> perAnnualEvalModelEmps) {
       this.id = id;
