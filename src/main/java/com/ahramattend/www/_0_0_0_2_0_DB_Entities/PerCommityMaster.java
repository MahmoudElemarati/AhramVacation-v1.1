...
public class PerCommityMaster  implements java.io.Serializable {
    ...
    public PerCommityMaster(PerCommityMasterId id, PerCommTypeCode perCommTypeCode, BudLocation budLocation) {
        this.id = id;
        this.perCommTypeCode = perCommTypeCode;
        this.budLocation = budLocation;
    }
    public PerCommityMaster(PerCommityMasterId id, PerCommTypeCode perCommTypeCode, BudLocation budLocation, String decisionNo, Date decisionDate, String commityGoal, String remarks, Set<PerPromotionTrans> perPromotionTranses) {
       this.id = id;
       this.perCommTypeCode = perCommTypeCode;
       this.budLocation = budLocation;
