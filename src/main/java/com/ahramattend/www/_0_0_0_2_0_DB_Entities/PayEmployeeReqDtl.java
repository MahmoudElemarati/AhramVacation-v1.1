...
public class PayEmployeeReqDtl  implements java.io.Serializable {
    ...
    public PayEmployeeReqDtl(PayEmployeeReqDtlId id, PayBandCode payBandCode, PayEmployeeReq payEmployeeReq, BigDecimal val) {
        this.id = id;
        this.payBandCode = payBandCode;
        this.payEmployeeReq = payEmployeeReq;
        this.val = val;
    }
    public PayEmployeeReqDtl(PayEmployeeReqDtlId id, PayBandCode payBandCode, PayEmployeeReq payEmployeeReq, BigDecimal val, Boolean creditType, BigDecimal creditBalance, String fiscalDegreeCode, Byte statusCode, Short statusGroup, Short bankCode, Long sarfCode, String jobCode, String orgId, String locCode, String locationCode, Boolean insClass, Integer execSeq, Short dayNo, BigDecimal val30, BigDecimal val65, BigDecimal val70, String tafkit) {
       this.id = id;
       this.payBandCode = payBandCode;
       this.payEmployeeReq = payEmployeeReq;
       this.val = val;
