...
public class PerEmpHistory  implements java.io.Serializable {
    ...
    public PerEmpHistory(PerEmpHistoryId id, PerEmploymentMasters perEmploymentMasters, PerGeneralCode perGeneralCode, PerJobCode perJobCodeByJobCode, Date transDate) {
        this.id = id;
    ...
    public PerEmpHistory(PerEmpHistoryId id, PerJobLaw perJobLaw, PerFiscalDegreeCodeNew perFiscalDegreeCodeNew, PerAttendanceWrkTypeDetail perAttendanceWrkTypeDetail, PerEmploymentMasters perEmploymentMasters, PerEmploymentParameter perEmploymentParameter, PerExternalSideCode perExternalSideCodeByPerehPerescFk, PerExternalSideCode perExternalSideCodeByPerehPerescFromFk, PerFiscalDegreeCode perFiscalDegreeCode, PerGeneralCode perGeneralCode, PerGroupTypeCode perGroupTypeCode, PerJobCode perJobCodeByJobCode, PerJobCode perJobCodeByJobCodeTransfer, PerLocationCodes perLocationCodesByPerehPerlcFromFk, PerLocationCodes perLocationCodesByPerehPerlcFk, PerMosqueCode perMosqueCode, PerOrganizationStructure perOrganizationStructureByOrgId, PerOrganizationStructure perOrganizationStructureByOrgIdFrom, PerOrgunitCode perOrgunitCodeByOrgunitCodeFrom, PerOrgunitCode perOrgunitCodeByOrgunitCode, BudLocation budLocationByLocationCodeFrom, BudLocation budLocationByLocationCode, BudProjectSub budProjectSubByPerehBudProjSFromFk, BudProjectSub budProjectSubByPerehBudProjSFk, Date transDate, Date degreeDate, Date jobDate, Date degreePriorityDate, Integer degreePriority, Boolean empJobFlag, Boolean empJobFlagNew, BigDecimal basicSalaryValue, BigDecimal salaryValue, BigDecimal contractValue, Boolean elawaType, Date elawaDate, BigDecimal elawaValue, String decisionNo, Date decisionDate, Boolean orgFlag, Boolean orgFlagFrom, String wrkTypeDecisionNo, Date wrkTypeDecisionDate, Date wrkTypeFromDate, Date wrkTypeToDate, String wrkTypeNotes, Date jobDateTransfer, Boolean cadreKind, Byte statusCode, Boolean chkEntryData, String recordCreateUser, Date recordUpdateDate, Date recordCreateDate, String recordUpdateUser, BigDecimal jobSalaryValue) {
       this.id = id;
