...
/**
 * PerAnnualEvalModelEmpDtlId generated by hbm2java
 */
@Embeddable
public class PerAnnualEvalModelEmpDtlId  implements java.io.Serializable {
    ...
    public PerAnnualEvalModelEmpDtlId() {
    }

    public PerAnnualEvalModelEmpDtlId(String locationCode, String employeeId, String serialNo, String annualId, String serialNoDetail) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PerAnnualEvalModelEmpDtlId) ) return false;
		 PerAnnualEvalModelEmpDtlId castOther = ( PerAnnualEvalModelEmpDtlId ) other; 
