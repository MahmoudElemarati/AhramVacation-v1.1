 ...
 * @author MSaeed
 */
public class _0_0_0_3_0_0_PerSectionCode_Ajax_3_DeleteFrom_PerSectionCode_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<PerSectionCode> pList = new PerSectionCode_DAO().getPerSectionCodeById(SecCode);
            if (pList.isEmpty()) {
                throw new Exception();
            } else {
                PerSectionCode m = pList.get(0);
                HibernateSessionCon.beginTrans();
                new PerSectionCode_DAO().delete(m);
