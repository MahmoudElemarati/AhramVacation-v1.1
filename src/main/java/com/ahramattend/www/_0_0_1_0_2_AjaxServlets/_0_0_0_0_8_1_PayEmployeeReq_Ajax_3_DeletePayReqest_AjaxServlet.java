 ...
 * @author Mohamed
 */
public class _0_0_0_0_8_1_PayEmployeeReq_Ajax_3_DeletePayReqest_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (pList.isEmpty()) {
                ...
                PayEmployeeReq m = pList.get(0);
                HibernateSessionCon.beginTrans();
                new PayEmployeeReq_DAO().delete(m);
