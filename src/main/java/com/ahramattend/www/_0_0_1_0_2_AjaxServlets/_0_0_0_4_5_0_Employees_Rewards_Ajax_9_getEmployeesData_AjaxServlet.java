 ...
 * @author Support
 */
public class _0_0_0_4_5_0_Employees_Rewards_Ajax_9_getEmployeesData_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<PayEmployeeMaster> pList = new PayEmployeeMaster_DAO().getPayEmployeeMasterByLocation(LocationCode, LocCode);
            if (pList.isEmpty()) {
                ...
                for (PayEmployeeMaster p : pList) {
                    ...
                    HTML_TEXT += "<tr " + color + ">\n"
                            ...
                            + "           <td>" + p.getEmpAname() + "</td>\n"
                            + "           <td>"
                            + "             <button type=\"button\" onclick=\"getEmployeeNoOut2('" + p.getEmployeeNo() + "');\" data-dismiss=\"modal\" class=\"fa fa-copy btn btn-success\" style=\"border: 2px solid white;\"></button>"
                            + "           </td>\n"
                            + "</tr>";
                }
            }
