 ...
 * @author MSaeed
 */
public class _0_0_0_1_0_5_Dash_EmpCount_KaderAndOrg_Ajax_0_getdataAnalysis_AjaxServlet extends HttpServlet {
        ...
        try {
            ...
            switch (SearchType) {
                case "1":   
                    ...
                    break;
                case "2":
                    plotByFisical(request,response);
                    break;
            }
    ...
    private void plotByOrg(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            request.getSession().setAttribute("_0_0_0_1_0_5_Dash_EmpCount_KaderAndOrg_Loading_1", "0");
            ...
            for (String gender : gList) {
                ...
                for (PerFiscalDegreeCode p : PerFiscalDegreeList) {
                    ...
                    long val = new PerEmploymentMasters_DAO<>().getGenderCountPerFesicalAndOrg(gender, p.getFiscalDegreeCode(), OrgId, locationCode, generalCode1);
                    values.add("" + val);

                    i++;
                    String message = "" + (int) ((i * 100.0) / size);
                    request.getSession().setAttribute("_0_0_0_1_0_5_Dash_EmpCount_KaderAndOrg_Loading_1", message);
                }
    ...
    private void plotByFisical(HttpServletRequest request, HttpServletResponse response) {
        try {
            String generalCode = request.getParameter("generalCode");
            String locationCode = request.getParameter("locationCode");
            String sexFlag = request.getParameter("sexFlag");
            ...
            for (PerOrganizationStructure p : OrgList) {
            ...
            for (String gender : gList) {
                ...
                for (PerOrganizationStructure p : OrgList) {
                    HibernateSessionCon.session.clear();
                    long val = new PerEmploymentMasters_DAO<>().getGenderCountPerFesicalAndOrg(gender, FiscalDegreeCode, p.getOrgId(), locationCode, generalCode1);
                    values.add("" + val);
