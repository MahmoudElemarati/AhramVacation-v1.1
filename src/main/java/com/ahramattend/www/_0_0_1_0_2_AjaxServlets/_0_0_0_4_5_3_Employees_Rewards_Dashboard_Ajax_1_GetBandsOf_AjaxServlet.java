 ...
 * @author Support
 */
public class _0_0_0_4_5_3_Employees_Rewards_Dashboard_Ajax_1_GetBandsOf_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int bar_i = 0;
            int size = LocCodes.size() * SeperatedDateIntervals.size();
            for (String LocCode : LocCodes) { // بعدي على كل المواقع
                ...
                for (DateInterval dates : SeperatedDateIntervals) { // بدي على كل الشهور المختارة للموقع الواحد
                    List<Object> pList = new PayDeserveEmp_DAO().getPayDeserveEmpByDateByLocCode(dates.getStartDate(), LocCode, locationCode);
                    if (!pList.isEmpty()) {
    ...
    private String createTableHeader(String rejects, String Parts, String detailType) {
        ...
        HTML_Text += "<thead style=\"background-color: #68b6ff !important;text-align: center !important;\"><tr>";
        if (detailType.equals("AllowDetails")) {
