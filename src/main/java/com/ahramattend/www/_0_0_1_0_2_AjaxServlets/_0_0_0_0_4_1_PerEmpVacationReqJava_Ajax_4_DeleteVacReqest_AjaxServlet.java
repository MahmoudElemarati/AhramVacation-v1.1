 ...
 * @author Mohamed
 */
public class _0_0_0_0_4_1_PerEmpVacationReqJava_Ajax_4_DeleteVacReqest_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (pList.isEmpty()) {
                ...
                PerEmpVacationReqJava m = pList.get(0);
                HibernateSessionCon.beginTrans();
                new PerEmpVacationReqJava_DAO().delete(m);
