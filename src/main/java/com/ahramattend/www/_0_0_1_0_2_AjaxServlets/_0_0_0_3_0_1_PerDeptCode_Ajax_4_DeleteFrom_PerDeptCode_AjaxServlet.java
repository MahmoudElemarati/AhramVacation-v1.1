 ...
 * @author MSaeed
 */
public class _0_0_0_3_0_1_PerDeptCode_Ajax_4_DeleteFrom_PerDeptCode_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<PerDeptCode> pList = new PerDeptCode_DAO().getPerDeptCodeById(DeptCode);
            if (pList.isEmpty()) {
                throw new Exception();
            } else {
                PerDeptCode m = pList.get(0);
                HibernateSessionCon.beginTrans();
                new PerDeptCode_DAO().delete(m);
