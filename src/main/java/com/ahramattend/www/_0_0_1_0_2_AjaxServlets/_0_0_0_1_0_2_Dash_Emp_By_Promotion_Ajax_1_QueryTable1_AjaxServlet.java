 ...
 * @author MSaeed
 */
public class _0_0_0_1_0_2_Dash_Emp_By_Promotion_Ajax_1_QueryTable1_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getSession().setAttribute("_0_0_0_1_0_2_Loading1", 10);
            //System.out.println(">>>  Starting");
            String HTML_Body = "";
            List<PerEmpPromotion> pList = new PerEmpPromotion_DAO().getAllPerEmpPromotion(jobLaw, PromotionType, PostDate);
            if (pList.isEmpty()) {
                HTML_Body = "<tr>\n"
                ...
                for (PerEmpPromotion p : pList) {
                    ...
                    try {
                        PromotionDate = "" + p.getPerPromotionTrans().getPromotionDate();
                    } catch (Exception ex) {
                        PromotionDate = "";
                    }
                    ...
                    try {
                        FiscalDegreeName = "" + p.getPerFiscalDegreeCodeByFiscalDegreeCode().getFiscalDegreeName();
                    } catch (Exception ex) {
                        FiscalDegreeName = "";
                    }
                    try {
                        FiscalDegreeNameNew = "" + p.getPerFiscalDegreeCodeByFiscalDegreeCodeNew().getFiscalDegreeName();
                    } catch (Exception ex) {
                        FiscalDegreeNameNew = "";
                    }
                    ...
                    if (message > 10) {
                        request.getSession().setAttribute("_0_0_0_1_0_2_Loading1", message);
                    }
            ...
            request.getSession().removeAttribute("_0_0_0_1_0_2_Loading1");
