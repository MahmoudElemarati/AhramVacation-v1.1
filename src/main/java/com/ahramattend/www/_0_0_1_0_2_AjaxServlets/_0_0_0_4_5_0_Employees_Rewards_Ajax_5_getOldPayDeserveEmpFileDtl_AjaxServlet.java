 ...
 * @author Support
 */
public class _0_0_0_4_5_0_Employees_Rewards_Ajax_5_getOldPayDeserveEmpFileDtl_AjaxServlet extends HttpServlet {
        ...
        try {
            ...
            if (pList.isEmpty()) {
                ...
                for (PayEmployeeMaster p : pList) {
                    ...
                    HTML_TEXT += "         <td>" + DrlBtn + "</td>\n"
                            + "           <td><input style=\"text-align: center;" + Color + "\" type=\"text\" class=\"form-control-custom empIdsClass\" value=\"" + p.getEmployeeNo() + "\" readonly=\"\"></td>\n"
                            + "           <td>" + p.getEmpAname() + "</td>\n"
            ...
            try {
                ...
                HTML_TEXT += "    <td style='background-color: #ffbdbd;'>لا توجد درجة مالية</td>\n";
                    ...
                    HTML_TEXT += "       <td><input style=\"text-align: center;" + Color + "\" type=\"text\" class=\"form-control-custom\" value=\"" + val + "\" readonly=\"\"></td>\n";
                    /*try {
                ...
                HTML_TEXT += "    <td style='background-color: #ffbdbd;'>لا توجد مجموعة مالية</td>\n";
                    ...
                    HTML_TEXT += "       <td><button type=\"button\" onclick=\"Delete('" + accessSp + "','" + p.getEmployeeNo() + "')\" class=\"fa fa-trash btn btn-danger\" style=\"font-size: large;font-weight: bold;border: 2px solid white;\"></button></td>\n"
                            + "</tr>";
                }
