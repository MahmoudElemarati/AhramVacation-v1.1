...
<html lang="en">
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="title_right">
                                                    <h3 style="font-size: 20px;">مجموع الذكور بكافة الكوادر العلمية : <span id="male_count">0</span></h3>
                                                </div>
                                                <div class="title_left">
                                                    <h3 style="font-size: 20px;">مجموع الإناث بكافة الكوادر العلمية : <span id="female_count">0</span></h3>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12 form-group">                                            
                                                    <button type="button" data-original-title="إعادة تكوين الرسم البياني" onclick="refresh('bar', '<%=plotType%>', '<%=generalCode%>', '<%=locationCode%>', '<%=sexFlag%>', '<%=color_1%>', '<%=color_2%>', 'flase');" class="btn btn-app" style="border-style: solid;border-color: #169f85;font-size: 15px;"><i class="fa fa-repeat" style="color: #169f85;"></i>إعادة تكوين الرسم</button>
                                                </div>
                                            </div>                                            
    ...
    <script src="_0_0_0_1_0_4_Dash_EmpCount_Kader.js"></script>
    <script>refresh('bar', '<%=plotType%>', '<%=generalCode%>', '<%=locationCode%>', '<%=sexFlag%>', '<%=color_1%>', '<%=color_2%>', 'true');</script>
    <%
