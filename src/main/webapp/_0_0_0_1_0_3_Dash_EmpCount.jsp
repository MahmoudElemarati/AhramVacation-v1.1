...
<html lang="en">
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="title_right">
                                                    <h3 style="font-size: 20px;">مجموع الذكور بكافة الإدارات : <span id="male_count">0</span></h3>
                                                </div>
                                                <div class="title_left">
                                                    <h3 style="font-size: 20px;">مجموع الإناث بكافة الإدارات : <span id="female_count">0</span></h3>
                                                </div>
                                            </div>
                                            <div class="row">
    ...
    <script src="_0_0_0_1_0_3_Dash_EmpCount.js"></script>
