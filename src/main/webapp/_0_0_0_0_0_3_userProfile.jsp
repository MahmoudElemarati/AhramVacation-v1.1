                                                ...
                                                <ul class="col-md-12" style="font-size: large;background-color: #f5f7fa;">
                                                    ...
                                                    <li style="color: #0a57a7;font-weight: bold;"><i class="fa fa-calendar user-profile-icon" ></i> تاريخ الميلاد : <h style="color: black;"><%=BirthDate%>.</h2>
                                                        ...
                                                        <li style="color: #0a57a7;font-weight: bold;"><i class="fa fa-map-marker user-profile-icon"></i> العنوان : <h style="color: black;"><%=LocAddress%>.</h2>
                                                            ...
                                                            %>
                                                            <li style="color: #0a57a7;font-weight: bold;"><i class="fa fa-briefcase user-profile-icon"></i> الوظيفة : <h style="color: black;"><%=JobName%>.</h2>
                                                                </li><br>
                                                                ...
                                                                <%
                                                                    ...
                                                                    if (orgFlage == 1) {
                                                                        ...
                                                                        try {
                                                                            OrgunitName = m.getPerCityCode().getPerGovernorateCode().getPerCountryCode().getACountryName();
                                                                        } catch (Exception ex) {
                                                                            OrgunitName = "لا يوجد مستوى";
                                                                        }
                                                                        try {
                                                                            OrgName = m.getPerExternalSideCodeByPeremPerescFk().getExternalSideName();
                                                                        } catch (Exception ex) {
                                                                            OrgName = "لا يوجد مستوى";
                                                                        }
                                                                        try {
                                                                        ...
                                                                        try {
                                                                            OrgunitName = m.getBudProjectSubByPeremBudProjSFk().getLastUpdateTransaction();
                                                                        } catch (Exception ex) {
                                                                            OrgunitName = "لا يوجد مستوى";
                                                                        }
                                                                        try {
                                                                ...
                                                                %>
                                                                <li style="color: #0a57a7;font-weight: bold;"><i class="fa fa-bank user-profile-icon"></i> الإدارة : <h style="color: black;"><%=OrgunitName%> - <%=OrgName%> - <%=LocName%>.</h2>
                                                                    </li><br>
                                                                    <%
                                                                        String ManagerName = "";
                                                                        try {

                                                                            String empDirectBossId = m.getPerOrganizationStructureByOrgId().getEmpDirectBoss();
                                                                            if (employee_session.getEmployeeId().equals(empDirectBossId)) {
                                                                                empDirectBossId = m.getPerOrganizationStructureByOrgId().getEmpBigBoss();
                                                                            }
                                                                            if (employee_session.getEmployeeId().equals(empDirectBossId)) {
                                                                                ManagerName = "لا يوجد مدير";
                                                                            } else {
                                                                                List<PerEmploymentMasters> PerEmploymentMastersBossList = new PerEmploymentMasters_DAO().getEmployeesByEmployeeID(empDirectBossId);
                                                                                PerEmploymentMasters PerEmploymentMastersByEmployeeIdBoss = PerEmploymentMastersBossList.get(0);

                                                                                ManagerName = PerEmploymentMastersByEmployeeIdBoss.getEmpAname();
                                                                            }
                                                                        } catch (Exception ex) {
                                                                            ManagerName = "لا يوجد مدير";
                                                                        }
                                                                    %>
                                                                    <li style="color: #0a57a7;font-weight: bold;"><i class="fa fa-user user-profile-icon"></i> المدير المباشر : <h style="color: black;"><%=ManagerName%>.</h2>
                                                                        </li>
                                                                        <br>
                                                                        <br>
                                                                        <br>
