                                        ...
                                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12" style="background-color: #f5f7fa;border-style: groove;">
                                            <div class="form-group" style="font-size: large;background-color: #f5f7fa;">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" name="" id="decisionNoSearch"  value="" required="">
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><br>
                                                    <button type="button" class="fa fa-search btn btn-primary form-control" onclick="QuerySheet();" style="font-size: large;font-weight: bold;border: 2px solid black;box-shadow: -1px 5px 8px black;"> بحث</button>                                               
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <br>
                                                </div>
