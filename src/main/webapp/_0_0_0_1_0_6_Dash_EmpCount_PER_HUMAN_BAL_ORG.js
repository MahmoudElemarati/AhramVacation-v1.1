...
function createTable(data) {
    var header = "";
    header = "<th style='text-align: center;font-size: 15px;'>البيان</th>"
            + "<th style='text-align: center;font-size: 15px;'>العدد</th>";
...
/////////////////////////////////////////////////////////////
    ...
    $.each(data, function (index, mainData) {
        ...
        body = body + "<tr><td>الإجمالي</td><td>" + total + "</td></tr>";
        document.getElementById("bodyDiv").innerHTML = body;
        reloadDataTable();
    });
    // body end
...
function refresh(chartType, plotType, locationCode, year, color_1, color_2, loadtable) {
    status = 't';
    setTheme(color_1, color_2);
    $.ajax({
        url: "_0_0_0_1_0_6_Dash_EmpCount_PER_HUMAN_BAL_ORG_Ajax_0_getdataAnalysis_AjaxServlet?"
...
function getLoad() {
    //alert(status);
    var URL = "_0_0_0_1_0_6_Dash_EmpCount_PER_HUMAN_BAL_ORG_Ajax_1_getLoad_1_AjaxServlet?";
