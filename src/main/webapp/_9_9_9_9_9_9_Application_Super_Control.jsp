...
<%@page import="com.ahramattend.www._0_0_0_3_0_DB_DAOs.AppSubTabAuthType_DAO"%>
<%@page import="com.ahramattend.www._0_0_0_2_0_DB_Entities.AppSubTabAuthType"%>
<%@page import="com.ahramattend.www._0_0_0_2_0_DB_Entities.AppSubTabAuthType"%>
                            ...
                            <div class="x_content" style="display: block;direction: ltr;float :left;">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group" style="float: left;">
                                        ...
                                        <input style="font-size: 15px;font-weight: bold;" type="text" placeholder="Filter Name" autocomplete="ON"  maxlength="100" data-placement="bottom" id="filterName" name="filterName" class="form-control" required="">
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group" style="float: left;">
                                        <label class="control-label" style="font-size: 20px;">Filter Path</label>
                                        <input style="font-size: 15px;font-weight: bold;" type="text" placeholder="Filter Path" autocomplete="ON" maxlength="100" data-placement="bottom" id="filterPath" name="filterPath" class="form-control" required="">
                                    </div>
                                </div>
                                <div class="row">
                                    <br>
