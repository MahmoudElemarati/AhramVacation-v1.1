...
<html lang="en">
    <head>
        ...
        <title>اعتماد طلبات مفردات المرتب للموظفين</title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">اعتماد طلبات مفردات المرتب للموظفين</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead style="background-color: #68b6ff;">
                                        <tr>
                                            ...
                                            <th style="text-align: center;font-size: 15px;width: 10%;">تاريخ الطلب</th>
                                            <th style="text-align: center;font-size: 15px;width: 35%;">الملاحظات</th>
                                            <th style="text-align: center;"><img src="webDesign/production/images/mail1.png" alt="" border=1 height=30 width=30></th>
                                            <th style="text-align: center;"><img src="webDesign/production/images/correctmark1.png" alt="" border=1 height=30 width=30></th>
                                        </tr>
                                    </thead>
                        ...
                        <script>
                            ...
                            Load_PayEmployeeReqForApproval();
                            function Load_PayEmployeeReqForApproval() {
                                var PageSource = "1";
                                var URL = "_0_0_0_0_8_1_PayEmployeeReq_Ajax_2_LoadReqTable_AjaxServlet?PageSource=" + PageSource;
