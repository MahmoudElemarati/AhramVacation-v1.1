...
<%
    ...
    try {
        ...
        if (key.equals("Open")) {
            ...
            String fileSerial = (String) request.getSession().getAttribute("fileSerial");
            String fileDocSerial = (String) request.getSession().getAttribute("fileDocSerial");
            List<PerEmpFileDoc> pList = new PerEmpFileDoc_DAO().getDocPhotoByID(fileSerial, fileDocSerial, employee_session.getEmployeeId());
...
<html lang="en">
    <head>
        ...
        <title>طباعة مستند خاص  بالموظف</title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">طباعة مستندات الموظف</h3>
                            </div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            ...
                            <div class="row" >
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                                    <div class="x_panel">
                                        <!-- for Edit -->
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="FullPrint">
                                            <table border="1">
                                                <tbody >
                                                    <tr>
                                                        <td><img src="_0_0_0_0_0_0_LoadPhotoAjax?screenNum=000061&fileSerial=<%=m.getId().getFileSerial()%>&emp_id=<%=employee_session.getEmployeeId()%>&fileDocSerial=<%=m.getId().getFileDocSerial()%>" alt="image" width="100%"  border=0 style=""></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
...
<%                        } else {
    ...
    request.getSession().removeAttribute("fileSerial");
    request.getSession().removeAttribute("fileDocSerial");
