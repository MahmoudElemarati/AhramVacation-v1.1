...
<%@page import="com.ahramattend.www._0_0_0_3_0_DB_DAOs.AppEmployeeReqJ2221_DAO"%>
<%@page import="com.ahramattend.www._0_0_0_2_0_DB_Entities.AppEmployeeReqJ2221"%>
<%@page import="com.ahramattend.www._0_0_0_2_0_DB_Entities.AppEmployeeReqJ444"%>
<%@page import="com.ahramattend.www._0_0_0_2_0_DB_Entities.AppEmployeeReqJ222"%>
<%@page import="com.ahramattend.www._0_0_0_3_0_DB_DAOs.AppEmployeeReqJ222_DAO"%>
<%@page import="com.ahramattend.www._0_0_0_3_0_DB_DAOs.AppEmployeeReqJ444_DAO"%>
...
<%
    ...
    try {
        ...
        if (key.equals("Open")) {
            ...
            String employeeNo = "";
            String checkStatus = (String) request.getSession().getAttribute("checkStatus");
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="" class="table">
                                        <tbody>
                                            <tr>
                                                <%
                                                    List< PerEmploymentMasters> EmpNoList = new PerEmploymentMasters_DAO().getEmployeesByEmployeeNo(employeeNo);
                                                    if (EmpNoList.isEmpty()) {
                                                        employeeNo = "لا يوجد رقم موظف";
                                                    } else {
                                                        PerEmploymentMasters empNo = EmpNoList.get(0);
                                                ...
                                                <td style="text-align: right;font-size: 20px;font-weight:bold;width:10%;"><%=empNo.getEmpAname()%></td>                                                
                                            ...
                                            <tr>
                                                <%
                                                    ...
                                                    try {
                                                        OrgName = "" + empNo.getPerOrganizationStructureByOrgId().getOrgName();
                                                    } catch (Exception ex) {
                                            ...
                                            <tr>
                                                <%
                                                    String job, degree;
                                                    try {
                                                        job = "" + empNo.getPerJobCodeByJobCode().getJobName();
                                                    } catch (Exception ex) {
                                                        job = "لا يوجد وظيفة";
                                                    }
                                                    try {
                                                        try {
                                                            degree = "" + empNo.getPerFiscalDegreeCodeNew().getFiscalDegreeNameNew();
                                                        } catch (Exception c) {
                                                            degree = "" + empNo.getPerFiscalDegreeCode().getFiscalDegreeName();
                                                        }
                                                    } catch (Exception ex) {
                                                    ...
                                                    <table id="DesVal" border="1" class="table">
                                                        ...
                                                        <tbody> 
                                                            <%
                                                                ...
                                                                List<AppEmployeeReqJ2221> eList = null;
                                                                if (checkStatus.equals("others")) {
                                                                    eList = new AppEmployeeReqJ2221_DAO().getAppEmployeeReqJ2221ByEst7qaqatForOther(ReqSp, employeeNo);
                                                                } else {
                                                                    eList = new AppEmployeeReqJ2221_DAO().getAppEmployeeReqJ2221ByEst7qaqatForSelf(ReqSp, employeeNo);
                                                                }
                                                                for (AppEmployeeReqJ2221 e : eList) {
                                                                    TotalMost7kat += Double.parseDouble(e.getVal().toString());
                                                                    try {
                                                                        if (e.getId().getBandType() == 31 && e.getId().getBandType() == 1) {
                                                            %>
                                                            <tr> 
...
<%                      }
    ...
    request.getSession()
            .removeAttribute("ReqSp");
    request.getSession()
            .removeAttribute("employeeNo");
    request.getSession()
            .removeAttribute("OpenHTMLFile");
