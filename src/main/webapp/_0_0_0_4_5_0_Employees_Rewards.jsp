...
<%@page import="com.ahramattend.www._0_0_0_2_0_DB_Entities.PayMethodType"%>
<%@page import="com.ahramattend.www._0_0_0_3_0_DB_DAOs.PayMethodType_DAO"%>
...
<html lang="en">
    <head>
        ...
        <title>مكافآت خاصة بالموظفين</title>
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
        <div class="container body">
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">مكافآت خاصة بالموظفين</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                            ...
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                <div class="x_content" style="font-size: large;font-weight: bold;">
                                    ...
                                    <div class="row" style="text-align: center;">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="statusDiv">
                                        </div>
                                    </div>
                                    <div class="row"><br>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <label class="control-label">إسم الجهة</label>
                                            <%
                                                String LocationName = "";
                                                String LocationCode = "";
                                                String BackGround = "";
                                            ...
                                            %>
                                            <input type="text" class="form-control" value="<%=LocationName%>" required="" readonly="" style="<%=BackGround%>">
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <%
                                                String LocName = "";
                                            ...
                                            <input type="text" class="form-control" value="<%=LocName%>" required="" readonly="" style="<%=BackGround%>">
                                        </div>                                                                                                     

                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <label class="control-label" style="font-size: 20px;"> إسم المكافأة</label>

                                            <select style="font-size: 15px;font-weight: bold;" onchange="getExecMM();" type="text" placeholder="إسم البند" id="bandCode" maxlength="6" name="methodType" class="form-control" required="">
                                                <option value="">اختر المكافأة ....</option>
                                                <%
                                                    try {
                                                        List<PayBandCode> PayBandCodeList = new PayBandCode_DAO().getPayBandCodeByLocation(LocCode, LocationCode);
                                                        for (PayBandCode p : PayBandCodeList) {
                                                %>
                                                <option value="<%=p.getId().getBandCode()%>-<%=p.getId().getBandType()%>"><%=p.getBandName()%></option>
                                                <%
                                                    }
                                                } catch (Exception ex) {
                                                %>
                                                <option value="">لا يوجد مكافآت</option>
                                                <%
                                                    }
                                                %>
                                            </select>
                                    ...
                                    <div class="row" style="border-style: solid;border-color: #337ab7;background-color: #d8eaf1;">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <label class="control-label" style="font-size: 20px;">إحصائية متابعة التسجيل </label>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <label class="control-label" style="font-size: 15px;"> العدد داخل الموقع</label>
                                            <div class="form-control" style="text-align: center;" id="NoOfEmpIn">
                                                0
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <label class="control-label" style="font-size: 15px;"> العدد خارج الموقع</label>
                                            <div class="form-control" style="text-align: center;" id="NoOfEmpOut">
                                                0
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <label class="control-label" style="font-size: 15px;"> الإجمالي عدد الموظفين</label>
                                            <div class="form-control" style="text-align: center;" id="NoOfEmp">
                                                0
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <label class="control-label" style="font-size: 15px;"> إجمالي المكافأة</label>
                                            <div class="form-control" style="text-align: center;" id="tatalReward">
                                                0
                                            </div><br>
                                        </div>
                                    </div>
                                        ...
                                        <table id="" class="table table-striped table-bordered table-hover">
                                            <thead style="background-color: #337ab7;color: white;">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;font-size: 15px;width: 15%">القيمة</th>
                                                </tr>
                                            </thead>
                                            <tbody style="text-align: center;">
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" name="" id="rewardValue"  value="" required=""></td>
                                                </tr>                                        
                                            </tbody> 
                                            <tfoot>
                                                <tr>
                                                    <td colspan="3"><a href="#" data-toggle="modal" data-target=".EmpSearchModal" onclick="ResetModal();"  class="control-label fa fa-search" style="font-size: 20px;"> بحث بإسم الموظف</a></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3"><a href="#" data-toggle="modal" data-target=".DeptSearchModal" class="control-label fa fa-search" style="font-size: 20px;"> بحث بالإدارة</a></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                    <%
                                        boolean sendBtnAuthStatus = false;
                                        List<AppSubElemSpecAuth> asesaList = new AppSubElemSpecAuth_DAO().getEmpSubTabElementsSpecAuthInSubTab(employee_session.getEmployeeId(), "_0_0_0_4_5_0_Employees_Rewards_AccessServlet");
                                        for (AppSubElemSpecAuth a : asesaList) {
                                            if (a.getAppSubElem().getElementName().equals("Send Button")) {
                                                sendBtnAuthStatus = true;
                                                break;
                                            }
                                        }
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: center;" id="SendBTNDiv">
                                ...
                                <div class="x_content" style="font-size: large;font-weight: bold;">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <table id="" class="table table-striped table-bordered table-hover">                                            
                                            <thead style="background-color: #337ab7;color: white;">
                                                <tr>
                                                    <th style="text-align: center;font-size: 15px;width: 1%;"></th>
                                                    <th style="text-align: center;font-size: 15px;width: 20%;">رقم الموظف</th>
                                                    <th style="text-align: center;font-size: 15px;width: 20%;">اسم الموظف</th>
                                                    <th style="text-align: center;font-size: 15px;width: 1%;">الرقم القومي</th>
                                                    <!--<th style="text-align: center;font-size: 15px;">الإدارة</th>-->
                                                    <!--<th style="text-align: center;font-size: 15px;width: 10%">الدرجة المالية</th>-->
                                                    <th style="text-align: center;font-size: 15px;width: 10%">القيمة</th>
                                                    <!--<th style="text-align: center;font-size: 15px;width: 10%">المجموعة المالية</th>-->
                                                    <th style="text-align: center;font-size: 15px;width: 1%"></th>
                                                </tr>
                                            </thead>
                                            <tbody id="EmpData" style="text-align: center;">
                                            </tbody>
                                            <!--<tfoot>
                                                <tr>
                                                    <td colspan="5" id="Btn">
                ...
                <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="background: #131e33;color: white;direction: rtl;">
                            ...
                            <h4 class="modal-title" id="myModalLabel2" style="font-size: 30px;">البحث عن موظف بالإسم</h4>
                        </div>
                        <div class="modal-body" >

                            <div class="row" id="DeleteFloorDone" style="direction: rtl;font-size: 30px;text-align: center;">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="font-size: 15px;text-align: right;">
                                    <label class="control-label">
                                        <strong class="fa fa-circle" style="color: #ffbdbd;"></strong> <strong>تعني أن الموظف غير مسجل بالموقع</strong>
                                    </label>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <table id="" class="table table-striped table-bordered table-hover">
                                        ...
                                        <thead style="background-color: #337ab7;color: white;">
                                            <tr>
                                                ...
                                                <th style="text-align: center;font-size: 15px;width: 30%">اسم الموظف</th>
                                                <th style="text-align: center;font-size: 15px;width: 30%">الموقع</th>
            ...
            <div class="modal fade DeptSearchModal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="background: #131e33;color: white;direction: rtl;">
                            ...
                            <h4 class="modal-title" id="myModalLabel2" style="font-size: 30px;">البحث عن موظف بالموقع</h4>
                        </div>
                        <div class="modal-body" >
                            ...
                            <div class="row" id="DeleteFloorDone" style="direction: rtl;font-size: 30px;text-align: center;">                                
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <table id="datatable" class="table table-striped table-bordered table-hover">                                        
                                        <thead style="background-color: #337ab7;color: white;">
                                            <tr>
                                                <th style="text-align: center;font-size: 15px;width: 30%">كود الموقع</th>
                                                <th style="text-align: center;font-size: 15px;width: 30%">اسم الموقع</th>
                                                <th style="text-align: center;font-size: 15px;width: 30%"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <%
                                                List<PerLocationCodes> plcList = new PerLocationCodes_DAO().getAllPerLocationCodes();
                                                if (plcList.isEmpty()) {
                                            %>
                                            <tr>
                                                <td colspan="4">لا يوجد قطاعات</td>
                                            </tr>
                                            <%
                                            } else {
                                                for (PerLocationCodes p : plcList) {


                                            %>
                                            <tr>
                                                <td><%=p.getId().getLocationCode()%>-<%=p.getId().getLocCode()%></td>
                                                <td><%=p.getLocName()%></td>
                                                <td>
                                                    <button type="button" onclick="getEmployeeInThisLoc('<%=p.getId().getLocationCode()%>','<%=p.getId().getLocCode()%>');" data-toggle="modal" data-target=".LoadEmpModal" class="fa fa-users btn btn-success" style="border: 2px solid white;"></button>
                                                </td>
                                            </tr>
            ...
            <div class="modal fade LoadEmpModal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                            ...
                            <div class="row" id="DeleteFloorDone" style="direction: rtl;font-size: 30px;text-align: center;">                                
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <table id="" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tfoot id="EmpDataFromDeptSearchResult">
            ...
            <div class="modal fade EmpDataDtl" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="background: #131e33;color: white;direction: rtl;">
                            ...
                            <h4 class="modal-title" id="myModalLabel2" style="font-size: 30px;">تفاصيل الموظف</h4>
                        </div>
                        <div class="modal-body" >
                            ...
                            <div class="row" id="DeleteFloorDone" style="direction: rtl;font-size: 30px;text-align: center;">                                
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <table id="" class="table table-striped table-bordered table-hover">                                        
                                        <thead style="background-color: #337ab7;color: white;">
                                            <tr>
                                                <th style="text-align: center;font-size: 15px;width: 15%">رقم الموظف</th>
                                                <th style="text-align: center;font-size: 15px;width: 30%">اسم الموظف</th>
                                                <th style="text-align: center;font-size: 15px;width: 30%">الموقع</th>
                                                <th style="text-align: center;font-size: 15px;width: 15%">الإدارة</th>
                                            </tr>
                                        </thead>
                                        <tbody id="EmpDataDtlTable">
        ...
        <script src="_0_0_0_4_5_0_Employees_Rewards.js"></script>
        <%
            /**
             * صلاحية زرار الإرسال
             */
            if (sendBtnAuthStatus) {
        %>
        <script>setSendButtonAuth("1");</script>
        <%
            }
        %>
