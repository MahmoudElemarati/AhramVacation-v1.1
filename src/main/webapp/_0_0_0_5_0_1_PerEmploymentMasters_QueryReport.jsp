                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <%
                            ...
                            List<PerEmploymentMasters> pList = new PerEmploymentMasters_DAO().getEmployeesByEmployeeNoAll(employeeNo);
                            ...
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;direction: rtl;" >
                                    ...
                                    <table  id="" class="table">
                                        <tbody>
                                            <tr> 
                                                ...
                                                <td style="text-align: right;font-size: 15px;font-weight:bold;width:22%;"><%=m.getEmpAname()%></td>
                                ...
                                <div class="row table-responsive">
                                    <table id="" class="table table-striped table-bordered table-hover">
                                        ...
                                        <!--<img src="webDesign/production/images/Spin-0.9s-200px.gif" alt="" border=1 height=50 width=50>-->
                                        <%
                                            List<PerEmpHistory> PerEmpHistoryList = new PerEmpHistory_DAO().get_Employees_EmpHistory("" + m.getEmployeeId());
                                ...
                                <table id="sig" border="0" class="table">
                                    <tr>
                                        <td style='text-align: center;'><img style="width: 100%; display: block;" src="_0_0_0_0_0_0_LoadPhotoAjax?screenNum=000061&fileSerial=1&emp_id=5523&fileDocSerial=1" alt="image" /></td>
                                        <td style='text-align: center;'><img style="width: 100%; display: block;" src="_0_0_0_0_0_0_LoadPhotoAjax?screenNum=000061&fileSerial=1&emp_id=5523&fileDocSerial=1" alt="image" /></td>
                                        <td style='text-align: center;'><img style="width: 100%; display: block;" src="_0_0_0_0_0_0_LoadPhotoAjax?screenNum=000061&fileSerial=1&emp_id=5523&fileDocSerial=1" alt="image" /></td>
                                        <td style='text-align: center;'><img style="width: 100%; display: block;" src="_0_0_0_0_0_0_LoadPhotoAjax?screenNum=000061&fileSerial=1&emp_id=5523&fileDocSerial=1" alt="image" /></td>
...
<%                        } else {
    ...
    request.getSession().removeAttribute("employeeNo");
    HibernateSessionCon.session.clear();
