...
function refresh(chartType, plotType, generalCode, locationCode, sexFlag, SearchType, OrgId, FiscalDegreeCode, color_1, color_2, loadtable) {
    status = 't';   
    setTheme(color_1, color_2);
    $.ajax({
        url: "_0_0_0_1_0_5_Dash_EmpCount_KaderAndOrg_Ajax_0_getdataAnalysis_AjaxServlet?"
...
function getLoad() {
    //alert(status);
    var URL = "_0_0_0_1_0_5_Dash_EmpCount_KaderAndOrg_Ajax_1_getLoad_1_AjaxServlet?";
