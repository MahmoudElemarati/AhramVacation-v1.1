...
<%@page import="com.ahramattend.www._0_0_0_2_0_DB_Entities.PerEmpPromotionNew"%>
<%@page import="com.ahramattend.www._0_0_0_3_0_DB_DAOs.PerEmpPromotion_DAO"%>
<%@page import="com.ahramattend.www._0_0_0_2_0_DB_Entities.PerEmpPromotion"%>
...
<%
    ...
    try {
        ...
        if (key.equals("Open")) {
            ...
            String jobLaw = (String) request.getSession().getAttribute("jobLaw");
            String PromotionType = (String) request.getSession().getAttribute("PromotionType");
            String PostDate = (String) request.getSession().getAttribute("PostDate");
                ...
                <div class="right_col" role="main">
                    <div class="">
                        <div class="page-title">
                            ...
                            <script>
                                function printDiv() {
                                    ...
                                    var divID = document.getElementById("Dash2Print").innerHTML;
                        ...
                        <div id="FullPrint" style="">
                            <div class="title_right"><h3 style="font-weight: bold;float: right;"> احصائية عن الموظفين الذين تمت ترقياتهم خلال فترة</h3></div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="table_resetData" class="table table-striped table-bordered table-hover">
                                            <thead style="background-color: #337ab7;color: white;width: 100%;">
                                                <tr>
                                                    <th style="text-align: center;font-size: 15px;">رقم التأمين</th>
                                                    <th style="text-align: center;font-size: 15px;">اسم الموظف</th>
                                                    <th style="text-align: center;font-size: 15px;">تاريخ الترقية</th>
                                                    <th style="text-align: center;font-size: 15px;">المجموعة النوعية<br>قبل</th>
                                                    <th style="text-align: center;font-size: 15px;">المجموعة النوعية<br>بعد</th> 
                                                    <th style="text-align: center;font-size: 15px;">الدرجة المالية<br>قبل</th>
                                                    <th style="text-align: center;font-size: 15px;">الدرجة المالية<br>بعد</th>
                                                    <th style="text-align: center;font-size: 15px;">تاريخ شغل الدرجة<br>قبل</th>
                                                    <th style="text-align: center;font-size: 15px;">تاريخ شغل الدرجة<br>بعد</th>
                                                    <th style="text-align: center;font-size: 15px;">تاريخ اقدمية الدرجة<br>قبل</th>
                                                    <th style="text-align: center;font-size: 15px;">تاريخ اقدمية الدرجة<br>بعد</th>
                                                    <th style="text-align: center;font-size: 15px;">الدرجة بصفة شخصية<br>قبل</th>
                                                    <th style="text-align: center;font-size: 15px;">الدرجة بصفة شخصية<br>بعد</th>
                                                    <th style="text-align: center;font-size: 15px;">الوظيفة<br>قبل</th>
                                                    <th style="text-align: center;font-size: 15px;">الوظيفة<br>بعد</th>
                                                    <th style="text-align: center;font-size: 15px;">ت شغل الوظيفة<br>قبل</th>
                                                    <th style="text-align: center;font-size: 15px;">ت شغل الوظيفة<br>بعد</th>                                                
                                                    <th style="text-align: center;font-size: 15px;">الراتب الاساسي<br>قبل</th>
                                                    <th style="text-align: center;font-size: 15px;">علاوة الدرجة</th>
                                                    <th style="text-align: center;font-size: 15px;">الراتب الاساسي<br>بعد</th>
                                                </tr>
                                            </thead>
                                            <tbody id = "myTable1">
                                        ...
                                        <table id="table_resetData" class="table table-striped table-bordered table-hover">
                                            <thead style="background-color: #337ab7;color: white;width: 200%;">
                                                <tr>
                                                    <th style="text-align: center;font-size: 15px;">رقم التأمين</th>
                                                    <th style="text-align: center;font-size: 15px;">اسم الموظف</th>
                                                    <th style="text-align: center;font-size: 15px;">تاريخ الترقية</th>
        ...
        <div style="display:none;">
            ...
            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">                                   
                    ...
                    %>
                    <div id="Dash2Print">
                        <table id="" class="table table-striped table-bordered table-hover" style="direction: rtl;">
                            <thead style="background-color: #337ab7;color: white;width: 200%;">
                                <tr>
                                    <th style="text-align: center;font-size: 15px;">رقم التأمين</th>
                                    <th style="text-align: center;font-size: 15px;">اسم الموظف</th>
...
<script src="_0_0_0_1_0_2_Dash_Emp_By_Promotion.js"></script>

<script>Query('<%=jobLaw%>', '<%=PromotionType%>', '<%=PostDate%>');</script>
<script type="text/javascript">
    ...
    function init_DataTablesCustom() {
