...
<html lang="en">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color: #131e33;">
                                <div class="x_panel">
                                    ...
                                    <div class="x_title" style="display: block;">                                        
                                        <h2 style="width: 50%;font-weight: bold;float: right;color: #327ab7;">إحصائية الدرجات المتاحة لوظائف الكادر العلمي</h2>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12 form-group">                                            
                                                    <button type="button" data-original-title="إعادة تكوين الرسم البياني" onclick="refresh('bar', '<%=plotType%>', '<%=locationCode%>', '<%=year%>','<%=color_1%>', '<%=color_2%>', 'flase');" class="btn btn-app" style="border-style: solid;border-color: #169f85;font-size: 15px;"><i class="fa fa-repeat" style="color: #169f85;"></i>إعادة تكوين الرسم</button>
                                                </div>
                                            </div>                                            
    ...
    <script src="_0_0_0_1_0_6_Dash_EmpCount_PER_HUMAN_BAL_ORG.js"></script>
    <script>refresh('bar', '<%=plotType%>', '<%=locationCode%>', '<%=year%>','<%=color_1%>', '<%=color_2%>', 'true');</script>
    <%
