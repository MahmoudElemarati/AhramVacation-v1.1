...
<%@page import="com.ahramattend.www._0_0_0_3_0_DB_DAOs.PerSectionCode_DAO"%>
<%@page import="com.ahramattend.www._0_0_0_2_0_DB_Entities.PerSectionCode"%>
        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;"> ادخال الواحدات</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="" onchange="getSecCode();" id="LocCode" maxlength="45" name="LocCode" class="form-control" required="">
                                        <%
                                            String LocCode = "";
                                            List<PerLocationCodes> LList = new PerLocationCodes_DAO().getAllPerLocationCodes();
                                            for (PerLocationCodes p : LList) {
                                                LocCode = p.getId().getLocCode();
                                        %>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="نوع الاجازة" onchange="" id="SecCode" maxlength="45" name="SecCode" class="form-control" required="">
                                    ...
                                    <script>
                                        function getSecCode() {
                                            ...
                                            var URL = "_0_0_0_3_0_1_PerDeptCode_Ajax_2_getSecCode_AjaxServlet?LocCode=" + LocCode + "&LocationCode=" + LocationCode;
                                            ...
                                            xhttp.onreadystatechange = function () {
                                                if (xhttp.readyState === 4 && xhttp.status === 200) {
                                                    ...
                                                    if (message === "Error") {
                                                        ...
                                                        document.getElementById("SecCode").innerHTML = "<option value=\"\">اختر نمط المستفيد...</option>" + message;
                                                    }
                                                }
                                            };
                                        }
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group" id="">
                                    <label class="control-label" style="font-size: 20px;"> اسم الوحدة</label>
                                    <input style="font-size: 15px;font-weight: bold;" type="text" placeholder="اسم الوحدة" maxlength="100" data-placement="bottom" id="DeptName" name="DeptName" class="form-control" required="" value="">
                                </div>


                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
                                    <label class="control-label" style="font-size: 20px;"> الدور (اختياري)</label>
                                    <input style="font-size: 15px;font-weight: bold;" type="text" placeholder="الدور" maxlength="100" data-placement="bottom" id="DeptFloor" name="DeptFloor" class="form-control" required="" value="">
                                </div>
                            ...
                            <script>
                                ...
                                function clearAt() {
                                    ...
                                    document.getElementById("DeptName").style.borderColor = "#737373";
                                }
                                ...
                                function Add() {
                                    ...
                                    var DeptFloor = document.getElementById("DeptFloor").value;
                                    if (SecCode === "" || SecCode === null) {
                                        Warning("برجاء إدخال اسم القسم");
                                        document.getElementById('SecCode').style.borderColor = "red";
                                    } else if (DeptName === "" || DeptName === null) {
                                        Warning("برجاء إدخال اسم الوحدة");
                                        document.getElementById('DeptName').style.borderColor = "red";
                                        document.getElementById('SecCode').style.borderColor = "#737373";

                                    } else {
                                        document.getElementById('SecCode').style.borderColor = "#737373";
                                        document.getElementById('DeptName').style.borderColor = "#737373";
                                        var URL = "_0_0_0_3_0_1_PerDeptCode_Ajax_1_insertIntoPerDeptCode_AjaxServlet?LocationCode=" + LocationCode + "&LocCode=" + LocCode + "&SecCode=" + SecCode + "&DeptName=" + DeptName + "&DeptFloor=" + DeptFloor;
                                        var xhttp = new XMLHttpRequest();
                                        xhttp.open("POST", URL, true);
                                        xhttp.send();
                                        xhttp.onreadystatechange = function () {
                                ...
                                function Load_PerDeptCode_Table() {
                                    var URL = "_0_0_0_3_0_1_PerDeptCode_Ajax_3_Load_PerDeptCode_Table_AjaxServlet";
                                    var xhttp = new XMLHttpRequest();
                                    xhttp.open("POST", URL, true);
                                    xhttp.send();
                                    xhttp.onreadystatechange = function () {
                                        if (xhttp.readyState === 4 && xhttp.status === 200) {
                                            var message = xhttp.responseText;
                                            if (message === "Error") {
                                                document.getElementById("PerDeptCode_Data").innerHTML = ""
                                                        + "<tr>"
                                                        + "   <td colspan=\"11\"><img src=\"webDesign/img/Spin-0.9s-200px.gif\" alt=\"\" border=1 height=70 width=70></td>                                                                       \n"
                                                        + "</tr>";
                                                Table1Load = false;
                                            } else {
                                                document.getElementById("PerDeptCode_Data").innerHTML = message;
                                                Table1Load = true;
                                            }
                                        }
                                    };
                                ...
                                <table id="" class="table table-striped table-bordered table-hover">
                                    <thead style="background-color: #337ab7;color: white;">
                                        <tr>
                                            ...
                                            <th style="text-align: center;font-size: 15px;width: 15%;font-size: 20px;">اسم الوحدة</th>
                    ...
                    <script>
                        function DeleteFrom_PerDeptCode(DeptCode) {
                            var Confirm = confirm("هل أنت متأكد من إتمام عملية الحذف تلك");
                            if (Confirm === true) {
                                var URL = "_0_0_0_3_0_1_PerDeptCode_Ajax_4_DeleteFrom_PerDeptCode_AjaxServlet?DeptCode=" + DeptCode;
                                var xhttp = new XMLHttpRequest();
                                xhttp.open("POST", URL, true);
                                xhttp.send();
                                xhttp.onreadystatechange = function () {
