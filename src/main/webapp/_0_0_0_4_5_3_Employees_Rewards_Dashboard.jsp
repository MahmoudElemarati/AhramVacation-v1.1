...
<html lang="en">
    <head>
        ...
        <title>إحصائيات عن المكافآت</title>
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">إحصائيات عن المكافآت</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                ...
                                <%
                                    ...
                                    List<AppSubElemSpecAuth> asesaList = new AppSubElemSpecAuth_DAO().getEmpSubTabElementsSpecAuthInSubTab(employee_session.getEmployeeId(), "_0_0_0_4_5_3_Employees_Rewards_Dashboard_AccessServlet");
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <label class="control-label" style="font-size: 15px;"> نوع الإستعلام</label>
                                    <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="نوع الإستعلام"  id="SearchType" onchange="clearHtmlLocTable();searchTypeSelect();setLocCode(<%=LocCode%>, '<%=LocName%>');" maxlength="45" name="SearchType" class="form-control" required="">
                                ...
                                %>
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" id="CustomIntervalDiv" style="display: block;">
                                    <label class="control-label" style="font-size: 15px;">اختر الفترة</label>
                                ...
                                <%
                                    ...
                                    for (AppSubElemSpecAuth a : asesaList) {
                                        if (a.getAppSubElem().getElementName().equals("Details ComboBox")) {
                                            PartAvailable = true;
                                            break;
                                        }
                                    }
                                ...
                                <%                                   //
                                    boolean DetailTypeAvailable = false;
                                    for (AppSubElemSpecAuth a : asesaList) {
                                        if (a.getAppSubElem().getElementName().equals("Detail Type ComboBox")) {
                                            DetailTypeAvailable = true;
                                            break;
                                        }
                                    }

                                %> 
                                <div id="DetailTypeDiv">

                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"></div>           
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="border-style: solid;border-color: #006699;left: 4px;top: 10px;box-shadow: -1px 2px 5px 1px #929292;">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="LocCodeComboDiv" style="display: none;">
                                            <label class="control-label" style="font-size: 15px;"> اسم الموقع</label>
                                            <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="اسم الموقع" onchange="setLocCode(<%=LocCode%>, '<%=LocName%>');" id="LocCodeCombo" maxlength="45" name="LocCodeCombo" class="form-control" required="">
                                            ...
                                            <a href="#" onclick="addLocToTable();"><span class="input-group-addon" style="border: 2px solid #c7c7c7;"><i class="fa fa-arrow-left"></i></span></a>
                                            <a href="#" onclick="addAllLocToTable();"><span class="input-group-addon" style="border: 2px solid #c7c7c7;"><i class="fa fa-arrow-left"> إضافة كل المواقع</i></span></a>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <label class="control-label" style="font-size: 15px;"> المواقع المختارة</label>
                                            <table id="" class="table table-striped table-bordered table-hover table-wrapper-scroll-y my-custom-scrollbar">                                            
                                                <thead style="background-color: #286090;color: white;">
                                                    <tr>
                                                        <th style="text-align: center;font-size: 15px;">الكود</th>
                                                        <th style="text-align: center;font-size: 15px;">اسم الموقع</th>
                                                    </tr>
                                                </thead>                                            
                                                <tbody id="locationsTable" style="text-align: center;">                                                
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <button type="button" data-placement="top" id="searchResultByLoc" onclick="searchResultByLoc();" class="button_style btn btn-sm btn-primary button_position fa fa-search" style="box-shadow: -1px 2px 5px 1px black;font-weight: bold;font-size: 20px;"> إستعلام عن كل المكافآت بناءا على المواقع المختارة</button>
                                            <br><br>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="border-style: solid;border-color: #006699;right: 4px;top: 10px;box-shadow: -1px 2px 5px 1px #929292;">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <label class="control-label" style="font-size: 15px;"> إسم المكافأة</label>
                                            <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="إسم المكافأة" id="bandCode" maxlength="6" name="methodType" class="form-control" required="">
                                                <option value="" style="font-size: 15px;font-weight: bold;">اختر اسم المكافأة ..</option>                                                
                                                <%
                                                    List<PayBandCode> PayBandCodeList = new PayBandCode_DAO().getPayBandCode();
                                            ...
                                            <a href="#" onclick="addBandToTable();"><span class="input-group-addon" style="border: 2px solid #c7c7c7;"><i class="fa fa-arrow-left"></i></span></a>
                                            <a href="#" onclick="addAllBandToTable();"><span class="input-group-addon" style="border: 2px solid #c7c7c7;"><i class="fa fa-arrow-left"> إضافة كل المكافآت</i></span></a>
                                        </div>

                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <table id="" class="table table-striped table-bordered table-hover table-wrapper-scroll-y my-custom-scrollbar"> 
                                                <label class="control-label" style="font-size: 15px;"> المكافآت المختارة</label>
                                                <thead style="background-color: #286090;color: white;">
                                                    <tr>
                                                        <th style="text-align: center;font-size: 15px;">الكود</th>
                                                        <th style="text-align: center;font-size: 15px;">اسم المكافأة</th>
                                                    </tr>
                                                </thead>

                                                <tbody id="BandsTable" style="text-align: center;">                                                    
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <button type="button" data-placement="top" onclick="searchResultByBand();" class="button_style btn btn-sm btn-primary button_position fa fa-search" style="box-shadow: -1px 2px 5px 1px black;font-weight: bold;font-size: 20px;"> إستعلام بناءا على المكافآت المختارة</button>
                                            <br><br>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><br></div>
                                    <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border-style: solid;border-color: #006699;box-shadow: -1px 2px 5px 1px #929292;">                                                                            
                                        <textarea style="width: 100%;height: 200px;" id="consol"> </textarea>
                                    </div> -->
        ...
        <script src="_0_0_0_4_5_3_Employees_Rewards_Dashboard.js"></script>
        ...
        %>
        <script>setLocCode(<%=LocCode%>, '<%=LocName%>');</script>
        <%
            }
        %>
        ...
        <script>
            ...
            getPartAvailable(<%=PartAvailable%>);
            getDetailTypeAvailable(<%=DetailTypeAvailable%>);
            SearchTypeCombo();
