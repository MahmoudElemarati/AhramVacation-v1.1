...
<html lang="en">
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">حركات الحضور والانصراف</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    ...
                                    <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="نوع الاجازة" onchange="SearchTypeDivs();" id="searchType" maxlength="6" name="searchType" class="form-control" required="">
                                        <option value="all" style="font-size: 15px;font-weight: bold;">الكل..</option>
                                        <option value="emp" style="font-size: 15px;font-weight: bold;">موظف محدد..</option>
                                        <option value="org" style="font-size: 15px;font-weight: bold;">إدارة..</option>
                                    </select>
                                </div>
                                
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group" id="employeeIdDiv" style="display: none">
                                    <label class="control-label" style="font-size: 20px;"> رقم التأمين</label>
                                    <input style="font-size: 15px;font-weight: bold;" type="number" placeholder="" maxlength="45" data-placement="bottom" id="employeeId" name="employeeId" class="form-control" required="">
                                </div>
                                
                                 <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" id="OrgCodeDiv" style="display: none">
                                    <label class="control-label" style="font-size: 20px;">الإدارة</label>
                                    <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="" onchange="" id="OrgCode" maxlength="45" name="OrgCode" class="form-control" required="">
                                        ...
                                        %>
                                        <option style="font-size: 15px;font-weight: bold;" value="<%=p.getOrgCode()%>"><%=p.getOrgName()%></option>
                                        <%
                                            }
                                        %>
                            ...
                            <div class="row"> 
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <div class='input-group date' id='myDatepicker4' style="direction: ltr;">
                                        <input style="font-size: 20px;font-weight: bold;" data-toggle="tooltip" data-original-title="هنا يتم كتابة بداية الفترة المراد البحث من خلالها" type='text' class="form-control" id="SearchstartDate" name="SearchstartDate" readonly="readonly" />
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <div class='input-group date' id='myDatepicker5' style="direction: ltr;">
                                        <input style="font-size: 20px;font-weight: bold;" data-toggle="tooltip" data-original-title="هنا يتم كتابة نهاية الفترة المراد البحث من خلالها"  type='text' class="form-control" id="SearchEndDate" name="SearchEndDate" readonly="readonly" />
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>                               
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 form-group" id="">                                            
                                    <button type="button" data-placement="top" onclick="Load_PerAttendanceExistZk_ForAll();" class="button_style btn btn-sm btn-primary button_position fa fa-search" style="box-shadow: -1px 2px 5px 1px black;font-weight: bold;font-size: 15px;" data-toggle="modal" data-target="#x"> استعلام</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <table id="" class="table table-striped table-bordered table-hover">
                                    <thead style="background-color: #68b6ff;">
                                        <tr>
                                            ...
                                            <th style="text-align: center;font-size: 15px;width: 20%">الإدارة</th>
                                            <th style="text-align: center;font-size: 15px;width: 10%">التاريخ</th>
                                            <th style="text-align: center;font-size: 15px;width: 10%">وقت تسجيل الدخول</th>
                                            <th style="text-align: center;font-size: 15px;width: 10%">وقت تسجيل الخروج</th>
                                            <th style="text-align: center;font-size: 15px;width: 20%">تفاصيل الحركة</th>
                                        </tr>
                                    </thead>
                                    <tbody id="PerAttendanceExistZk_ForAll_Table">
                                    </tbody>
                                </table>
                            </div>
                        </div>
        ...
        <script src="_0_0_0_2_0_1_PerAttendanceExistZk_For_All.js"></script>
    </body>
</html>
<%                        } else {
