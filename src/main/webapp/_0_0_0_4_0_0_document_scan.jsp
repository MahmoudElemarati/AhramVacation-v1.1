...
<html lang="en">
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
        <div class="container body">
                                ...
                                <div class="x_panel" style="box-shadow: -1px 2px 5px 1px grey;background-color: #1a3348;background-image: url('webDesign/production/images/template.jpg');">
                                    ...
                                    <div class="x_content" style="font-size: large;font-weight: bold;">
                                        ...
                                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12" style="background-color: #f5f7fa;border-style: groove;">
                                            <div class="form-group" style="font-size: large;background-color: #f5f7fa;">
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                        <label class="control-label" style="font-size: 15px;">رقم القرار</label>
                                                        <input type="text" class="form-control" name="" id="decisionNo"  value="" required="">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    <label class="control-label" style="font-size: 20px;"> نوع القرار</label>
                                                    <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="نوع القرار" id="decisionTypeCode" maxlength="45" name="item_name" class="form-control" required="">
                                                        <option value="" style="font-size: 15px;font-weight: bold;">اختر نوع القرار ..</option>                                                        
                                                        <%
                                                            List<PerDecisionTypeCode> pList = new PerDecisionTypeCode_DAO().getallPerDecisionTypeCode();
                                                            for (PerDecisionTypeCode p : pList) {
                                                        %>
                                                        <option style="font-size: 15px;font-weight: bold;" value="<%=p.getDecisionTypeCode()%>"><%=p.getDecisionTypeName()%></option>
                                                        <%
                                                            }
                                                        %>
                                                    </select>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="الجهة المصدرة للقرار" id="desicionSideCode" maxlength="45" name="item_name" class="form-control" required="">
                                                        <option value="" style="font-size: 15px;font-weight: bold;">اختر الجهة المصدرة للقرار ..</option>                                                        
                                                        <%
                                                            List<PerDesicionSideCode> sList = new PerDesicionSideCode_DAO().getallPerDesicionSideCode();
                                                            for (PerDesicionSideCode s : sList) {
                                                        %>
                                                        <option style="font-size: 15px;font-weight: bold;" value="<%=s.getDesicionSideCode()%>"><%=s.getDesicionSideName()%></option>
                                                        <%
                                                            }
                                                        %>
                                                    </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <textarea type="text" class="form-control" name="" id="decisionSubject"  value="" required="" style="resize: none;height: 150px;"></textarea>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <label class="control-label" style="font-size: 20px;">ملخص القرار</label>
                                                        <textarea type="text" class="form-control" name="" id="decisionSummary"  value="" required="" style="resize: none;height: 150px;"></textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <br>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
                                                        <table id="" class="table table-striped table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td><input onkeyup="getEmpDataAjax();" type="text" class="form-control" name="" id="searchEmpId"  value="" required=""></td>
                                                                    <td id="searchEmpData"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2" style="text-align: center;">الموظفين المعنيين بالقرار</td>
                                                                </tr>
                                                            </tbody>
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" >
                                            <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <label class="control-label" style="font-size: 30px;color: white;"> طريقة الإدخال</label>
                                                <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="طريقة الإدخال" onchange="ImageInputType();" id="imageInputType" maxlength="45" name="item_name" class="form-control" required="">
                                                    <option value="" style="font-size: 15px;font-weight: bold;">اختر طريقة الإدخال ..</option> 
                                                    <option value="pc" selected="" style="font-size: 15px;font-weight: bold;">تحميل صورة من الجهاز..</option>  
                                                    <option value="scann" style="font-size: 15px;font-weight: bold;">تصوير من الاسكانر مباشرة ..</option> 
                                                </select>
                                            </div>-->
                                            <div class="col-md-12 col-sm-12 col-xs-12 form-group" id="pcImagesDiv" style="display: block;">
                                                <!--------->
                                                <label for="filePicker" style="color:white;font-size: 25px;">اختر صورة</label>
                                                <input type="file" size="50" id="filePicker" onchange="showImage.call(this)" value="" accept=".png,.jpeg,.jpg" style="color:white;font-size: 25px;">
                                                <img src="webDesign/Resources/images/Upload.png"  name="" id="image" style="border: solid 5px #131e33;width: 50%;" >
                                                <textarea name="photo" id="base64textarea" placeholder="Base64 will appear here" cols="50" rows="15" style="display: none;"></textarea>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><br>
                                                    <button type="button" class="fa fa-arrow-down btn btn-success" onclick="addPhotoToImages();" style="font-size: 30px;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;width: 100%;"> إضافة الصورة</button>
                                                </div>
                                                <!--------->
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="scannImagesDiv" style="display: block;">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color: #f5f7fa;border-style: groove;">
                                                    <div class="profile_title" style="font-size: large;background-color: #f5f7fa;">                                                                                               
                                                        <div id="images">

                                                        </div>
                                                        <div id="imagesUpload">
                                                            <!--<img class="scanned" id="ii" src="">-->
                                                            <!--<textarea name="photo" id="scanntextarea" placeholder="Base64 will appear here" cols="50" rows="15" style="display: block;"></textarea>-->
                                                        </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
                                                    ...
                                                    <br>
                                                    <button type="button" class="fa fa-refresh btn btn-primary" onclick="alert(document.getElementsByClassName('scanned').length);" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"> كام صورة</button>
                                                    <button type="button" class="fa fa-refresh btn btn-primary" onclick="resetImages();" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"> Reset</button>
                                                    <button type="button" class="fa fa-print btn btn-default" onclick="scanToJpg();" style="font-size: large;font-weight: bold;border: 2px solid black;box-shadow: 7px 8px 11px black;"> Scan</button>                                               
                                                </div>                                                 

                                            </div>
                                        </div>  
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><br>
                                            <button type="button" class="fa fa-save btn btn-primary" onclick="Save();" style="font-size: 30px;font-weight: bold;border: 2px solid black;box-shadow: 7px 8px 11px black;width: 100%;"> حفظ</button>
                                        </div>
            ...
            <script src="webDesign/scanner/scanner.js" type="text/javascript"></script>
            <script src="_0_0_0_4_0_0_document_scan.js"></script>
