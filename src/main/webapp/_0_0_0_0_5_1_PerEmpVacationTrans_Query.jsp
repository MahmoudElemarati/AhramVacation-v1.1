                ...
                <div class="right_col" role="main">
                    ...
                    <script>
                        ...
                        function PerVacationTransTable() {
                            ...
                            var URL = "_0_0_0_0_5_1_PerEmpVacationTrans_Ajax_1_LoadAllPerEmpVacationTransTable_AjaxServlet?vacationCode=" + vacationCode + "&employeeId=" + <%=employee_session.getEmployeeId()%> + "&SearchstartDate=" + SearchstartDate + "&SearchEndDate=" + SearchEndDate + "&SearchType=" + SearchType;
                            var xhttp = new XMLHttpRequest();
                            xhttp.open("POST", URL, true);
                            xhttp.send();
                            xhttp.onreadystatechange = function () {
