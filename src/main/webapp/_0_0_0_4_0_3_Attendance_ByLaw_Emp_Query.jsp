...
<%
    ...
    try {
        ...
        String WorkTypeCode = request.getParameter("WorkTypeCode");
        String WorkTypeSeq = request.getParameter("WorkTypeSeq");
%>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
        <div class="container body">
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                                <div class="x_panel" style="box-shadow: -1px 2px 5px 1px grey;">

                                    <div class="x_content" style="font-size: large;font-weight: bold;">

                                        <div class="chosen-select-single mg-b-20 table-responsive">
                                            <table id="perEmpMasterByWrkDtlTable" class="table table-striped table-bordered table-hover">
                                                <thead style="background-color: #68b6ff;">
                                                    <tr>
                                                        <th style="text-align: center;font-size: 15px;width: 3%">رقم التأمين</th>
                                                        <th style="text-align: center;font-size: 15px;width: 8%">إسم الموظف</th>
                                                        <th style="text-align: center;font-size: 15px;width: 10%">الإدارة</th>                                                      
                                                    </tr>
                                                </thead>
                                                <tbody id="perEmpMasterByWrkDtl" style="text-align: center;font-size: 20px;">
            ...
            <script src="_0_0_0_4_0_3_Attendance_ByLaw_Emp_Query.js"></script>
            <!-- Custom Theme Scripts -->
            <script src="webDesign/build/js/custom.js"></script><script src="AuthJSm.js"></script>
            <script>QueryPerEmploymentMastersByattendTypeDtl(<%=WorkTypeCode%>,<%=WorkTypeSeq%>);</script>
