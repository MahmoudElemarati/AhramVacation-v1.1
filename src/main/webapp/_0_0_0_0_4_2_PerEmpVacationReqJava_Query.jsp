...
<html lang="en">
    <head>
        ...
        <title>الاستعلام عن الاجازات</title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">تقرير عن الاجازات</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                    ...
                                    <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="نوع الاجازة" onclick="GetEmployeeVacationBalance();" id="VacationCode" maxlength="45" name="item_name" class="form-control" required="">
                                        <option style="font-size: 15px;font-weight: bold;" value="0">الكل</option>
                                        <%
                                            List<PerVacationCode> pList = new PerVacationCode_DAO().getPerVacationCode();
                                ...
                                <script>
                                    function GetEmployeeVacationBalance() {
                                        ...
                                        if (VacationCode === "" || VacationCode === null) {
                                            ...
                                            document.getElementById("FilteredSearch").style.display = "none";
                                            ...
                                            document.getElementById("FilteredSearch").style.display = "block";
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" id="SearchTypeDiv">
                                    ...
                                    <select style="font-size: 15px;font-weight: bold;" type="text" placeholder="نوع البحث" onclick="SearchByDateShowDiv();" id="SearchType" maxlength="45" name="SearchType" class="form-control" required="">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group" id="FullSearch" style="display: none;">                                            
                                <button type="button" data-placement="top" onclick="" class="button_style btn btn-sm btn-primary button_position fa fa-search" style="box-shadow: -1px 2px 5px 1px black;font-weight: bold;font-size: 20px;" data-toggle="modal" data-target="#x"> استعلام</button>
                            </div>

                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group" id="FilteredSearch">                                            
                                <button type="button" data-placement="top" onclick="" class="button_style btn btn-sm btn-primary button_position fa fa-search" style="box-shadow: -1px 2px 5px 1px black;font-weight: bold;font-size: 20px;" data-toggle="modal" data-target="#x"> استعلام</button>
                            </div>
