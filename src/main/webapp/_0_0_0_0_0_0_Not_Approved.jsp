...
<html lang="en">
    ...
    <body class="nav-md" onload="TodayName();timeFunction();" style="color: #000000;" >
        <div class="container body">
            <div class="main_container">
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="color: red;font-weight: bold;"> دخول بشكل غير رسمي</h3>
                            </div>
                        </div>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" >
                                        <table border="0">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 30%;"><img src="webDesign/production/images/guard.png" alt="" width="70%"  border=0 style=""></td>
                                                    <td style="width: 70%;"><h3>انت لا تمتلك الصلاحيات الكافية للدخول لهذه الصفحة</h3><br>
                                                        <h3>سيتم تحويلك للصفحة الرئيسية بعد 5 ثوان</h3></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="align-items: center;font-weight: bold;">
                ...
                <script>
                    ...
                    function Redirect() {
                        window.location = '_0_0_0_0_0_2_WelcomePage.jsp';
                    }
